...
public class WeatherDataTest {
	...
	public void testWeatherDataParsing_Point () throws JSONException {
		...
		owm.LocalizedWeatherData.GeoCoord coord = weather.getCoord ();
		assertNotNull (coord);
		...
		List<owm.WeatherData.WeatherCondition> weatherConditions = weather.getWeatherConditions ();
		assertNotNull (weatherConditions);
		assertEquals (1, weatherConditions.size ());
		owm.WeatherData.WeatherCondition condition = weatherConditions.get (0);
	...
	public void testWeatherDataParsing_City () throws JSONException {
		...
		List<owm.WeatherData.Clouds.CloudDescription> conditions = clouds.getConditions ();
		assertNotNull (conditions);
		assertEquals (2, conditions.size ());
		owm.WeatherData.Clouds.CloudDescription cloudDescription = conditions.get (0);
